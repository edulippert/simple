...
var GlobalService = /** @class */ (function () {
    function GlobalService(http, location) {
        ...
        this.path = 'http://simpleapp-env.9hm8ppd2uj.us-east-2.elasticbeanstalk.com/api';
    }
...
module.exports = "<div id=\"wrapper\">\n\n  <app-sidebar [page]=\"page\" [items]=\"menu_items\"></app-sidebar>\n\n  <div id=\"content-wrapper\" class=\"d-flex flex-column\">\n    <div id=\"content\">\n\n      <app-header></app-header>\n\n      <div class=\"container-fluid\">\n        <div class=\"card shadow mb-4\">\n          <div class=\"card-header py-3\">\n            <h6 class=\"m-0 font-weight-bold text-primary\">Nova Garantia Raíz</h6>\n          </div>\n          <div class=\"card-body\">\n            <form (submit)=\"addMaintenance()\">\n              <div class=\"form-group\">\n                <label>Nome da Garantia</label>\n                <input type=\"text\" name=\"name\" class=\"form-control\" placeholder=\"Nome da Garantia\" [(ngModel)]=\"maintenance.name\">\n              </div>\n\n              <div class=\"form-group\">\n                <label>Descrição da Garantia</label>\n                <textarea name=\"description\" class=\"form-control\" placeholder=\"Descrição da Garantia\" [(ngModel)]=\"maintenance.description\"></textarea>\n              </div>\n\n              <div class=\"form-group\">\n                <label>Grupo</label>\n                <select name=\"group_id\" class=\"form-control\" [(ngModel)]=\"maintenance.group_id\">\n                  <option value=\"\">Selecione uma opção</option>\n                  <option *ngFor=\"let group of groups\" value=\"group.id\">{{ group.name }}</option>\n                </select>\n              </div>\n\n              <div class=\"form-group\">\n                <label>Item</label>\n                <select name=\"item_id\" class=\"form-control\" [(ngModel)]=\"maintenance.item_id\">\n                  <option value=\"\">Selecione uma opção</option>\n                  <option *ngFor=\"let item of items\" value=\"item.id\">{{ item.name }}</option>\n                </select>\n              </div>\n\n              <!-- <div class=\"form-group\">\n                <label>Grupo</label>\n                <select name=\"subitem_id\" class=\"form-control\" [(ngModel)]=\"maintenance.subitem_id\">\n                  <option value=\"\">Selecione uma opção</option>\n                  <option *ngFor=\"let subitem of subitems\" value=\"subitem.id\">{{ subitem.name }}</option>\n                </select>\n              </div> -->\n\n              <div class=\"form-group\">\n                <label>Tempo</label>\n                <input type=\"text\" name=\"amount\" class=\"form-control\" placeholder=\"Tempo da Garantia\" [(ngModel)]=\"maintenance.amount\">\n              </div>\n\n              <div class=\"form-group\">\n                <label>Período</label>\n                <select name=\"period\" class=\"form-control\" [(ngModel)]=\"maintenance.period\">\n                  <option value=\"\">Selecione uma opção</option>\n                  <option value=\"1\">Dias</option>\n                  <option value=\"2\">Semanas</option>\n                  <option value=\"3\">Meses</option>\n                  <option value=\"4\">Anos</option>\n                </select>\n              </div>\n\n              <div class=\"form-group\">\n                <label>Referência</label>\n                <input type=\"text\" name=\"reference\" class=\"form-control\" placeholder=\"Referência\" [(ngModel)]=\"maintenance.reference\">\n              </div>\n\n              <app-loading-button *ngIf=\"loading\"></app-loading-button>\n              <button *ngIf=\"!loading\" class=\"btn btn-primary\">Cadastrar</button>\n            </form>\n          </div>\n        </div>\n      </div>\n    </div>\n\n    <app-footer></app-footer>\n\n  </div>\n</div>\n"
...
var CreateMaintenanceComponent = /** @class */ (function () {
    ...
    CreateMaintenanceComponent.prototype.addMaintenance = function () {
        var _this = this;
        this.globalService.createMaintenance(this.maintenance).subscribe(function (data) {
            _this.globalService.goBack();
        });
    };
...
var CreatePatternMaintenanceComponent = /** @class */ (function () {
    ...
    CreatePatternMaintenanceComponent.prototype.addMaintenancePattern = function () {
        // this.loading = true;
        // this.globalService.createMaintenancePattern(this.maintenance).subscribe((data: any) => {
